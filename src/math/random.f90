...
contains
    ...
    ! initializes the buint-in rng
    subroutine initRng(seed, ndiscard)
    ...
    subroutine shuffle(n, a, seed)
        ...
        if (present(seed)) rndState = seed
        do i = n, 2, -1
            if (present(seed)) then
                r = xorshift64star(rndState)
            else
